...
<div class="table-responsive"  style="width:60%" id="Form_Ciclos" >
    ...
    <input type="text" id="Cod_Unidad"  size="20" value="<%out.println(Unidad); %>"  >
        <table class="table table-bordered" align="center" bg-ground="#D2D2D2">
                <tr>
                    <td width="150">
                        <form action="Configurar_Devolucion.jsp" method="post" name="nn">

                                        <!-- CICLO DEVOLUCIÓN -->
                           <div class="table table-bordered table-hover">
                                   <table class="table table-bordered" align="center">
                                       <caption class=""><h4><center><b>CICLO DE DEVOLUCIÓN</b></center></h4></caption>
                                       
                                               <tr>
                                                   <td><center><b>Fecha Inicio</b></center></td>  
                                                    <td><center><b>N°. Dias</b></center></td>
                                                    <td><center><b>Periodo</b></center></td>
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                     <input type="text" name="Periodo" id="Periodo" value="" size="10" ReadOnly >
                                           ...
                                           <tr>
                                               <td colspan="4" align="center">   <input type="button" class="btn btn-primary" id="Btn_Agregar_Ciclo"  value="Crear Lapso" class="registrar"   >
                                               </td>
                                           </tr>
                             </table>
                                                    <form>
                            ...
                            <div id="Lista_Ciclos_registrado">      </div>                               
                          </div>
...
<center><table>
    <tr>
        <td> 
            <select id="List_Ciclos"  class="form-control" required> 
            </td>
        <td>
            <input type="button" class="btn btn-primary" id="Btn_Abrir_Form_Ciclo"  value="Crear Ciclo" class="registrar">
             </td>

</table></center>                                                 
  <center> <table> 
       <tr><td>
               <Div id="Lista_Solados_Activos">
                   
               </Div>    
          </td></tr> 
        <tr><td>
               <Div id="Lista_Solados_Planilla">
                   
               </Div>    
          </td></tr> 
       
        <tr><td>
             <div align="center"><a href="Devolucion.jsp" class="btn btn-info" role="button">BANDEJA DE ENTRADA</a></div>
...
<table width="102%" border="0" align="center">
 ...
 //var Dias_Mes=daysInMonth(Mes_Anio[0],Mes_Anio[1]);
 //var ultimoDia = new Date(Mes_Anio[0], Mes_Anio[1] + 1, 0);
// var  Limite_Periodo = Date.parse(ultimoDia.getDate()+"-"+Mes_Anio[0]+"-"+Mes_Anio[1]);
  // alert(Limite_Periodo.getDate());
  ...
  if( parseInt(mes1)==parseInt(Mes_Anio[0]))
        {
      ...
      var Ciclo = $(List_Ciclos).val();
          ...
          $.post('../..//Configurar_Devolucion', {
                        ...
                        Agregar_Soldado_Planilla : "Lista_Solados_Activos"  
                            ...
                            {
                              //alert(responseText);MOSTRAR SI TIENE DOBLE ABASTECIMIENTO
                         ...
                         $.each(responseText,function(ind,Ciclo_EN) {
                                 ...
                                 $('#List_Ciclos').append($("<option>", { 
                                        value: Ciclo_EN.Id_Ciclo,
                                            text : Ciclo_EN.Numb_Dias +" Dias,  Del " +Ciclo_EN.Fech_Inicio+" Hasta " +Ciclo_EN.Fech_Fin
                                                    }));
...
$(document).ready(function()
 ...
 $("#Confirmacion_Guardado_Soldado" ).dialog({
  ...
  $( "#Form_Ciclos" ).dialog({
          modal: true,
         title: "Registro Ciclo de Devolución",
         width: 800,
         minWidth: 750,
         maxWidth: 800,
         show: "fold",
