 ...
 * @author WILSON
 */
public class Configurar_Abastecimiento extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
          ...
          out.println("<thead><td colspan='8' align='center' bgcolor='#D8D8D8'><b>LISTA DE SOLDADOS DE LA UNIDAD A ABASTECER</b></td>");
          out.println("</thead>");
          out.println("<tbody>");
          out.println("<tr>");
          out.println("<td align='center' bgcolor='#F2F2F2'><b>Nº</b></td>");
          out.println("<td align='center' bgcolor='#F2F2F2'><b>Grado</b></td>");
          out.println("<td align='center' bgcolor='#F2F2F2'><b>Apellidos Nombres</b></td>");
          out.println("<td align='center' bgcolor='#F2F2F2'><b>Identificación</b></td>");
          out.println("<td align='center' bgcolor='#F2F2F2'><b>#.Dias</b>");
          out.println("<td align='center' bgcolor='#F2F2F2' width='100px'><b>Fecha Inicio</b></td>");
          out.println("<td align='center' bgcolor='#F2F2F2' width='80px'><b>Fecha Terminación</b></td>");
          ...
          if(request.getParameter ("Lista_Solados_Activos") !=null )
              {
                 ...
                 out.println("<tr>");
                 out.println("<td colspan='5' bgcolor='#D8D8D8'><center> <b>LISTA DE SOLDADOS DE LA UNIDAD</b> </td>  </tr>");       
                 out.println("<tr>");             
                ...
                out.println("<td align='center'  bgcolor='#F2F2F2'><b>Apellidos Nombres</b></td>");                
                out.println("<td align='center'  bgcolor='#F2F2F2'><b>Identificación</b></td> ");
                out.println(" <td align='center'  bgcolor='#F2F2F2'><b>Seleccionar</b></td>");                  
                out.println("</tr>");
                out.println("</thead>");
                out.println("<tbody>");        
                out.println("<tr>");        
                                     ...
                                     try{   
                                       ...
                                       while(Res3.next()){
                                       j++;
                                       out.println("<tr><td align='center'>"+j+"</td><td align='center'>"+Res3.getString("Grado")+"</td><td>"+Res3.getString("Apellidos")+" "+Res3.getString("Nombres")+"<td align='center'>" + Res3.getString("Ident_Sold")+"<td align='center'>"
                        ...
                        try{
                           ...
                           out.println("1");
                            ...
                            ///out.println("<A href='javascript:Confirmacion_Guardado_Soldado("+Ident+")' class=\"btn btn-info\" role=\"button\">REGISTRAR </A>");
                                        ...
                                        out.println("<center><table border='1' class='table table-bordered'>"); 
                                        out.println("<tr>");
                                        out.println("<td>");    
                                    ...
                                    do {
                                         ...
                                         out.println("<td align=\'center\'>"+Rs.getString("Numb_Dias")+"</td>" );
                                         out.println("<td align=\'center\'>"+Rs.getString("Fech_Inicio")+"</td>" );
                                         out.println("<td align=\'center\'>"+Rs.getString("Fech_Fin")+"</td>" );
                                         out.println("<td align=\'center\'>"+Rs.getString("Tipo_Ciclo")+"</td>" );

                                        } while (Rs.next());
                                    
                                        out.println(" </td></tr></TABLE><br><br>"); 
                                         out.println("¿AUTORIZA EL DOBLE ABASTECIMIENTO PARA ESTE SOLDADO? <BR><BR>"); 
                                        out.println("<A href='javascript:Confirmacion_Guardado_Soldado("+Ident+")' class=\"btn btn-info\" role=\"button\">SÍ</A>");
                                        out.println("<A href='javascript:Cancelar_Guardado_Soldado()' class=\"btn btn-info\" role=\"button\">NO</A>");
          ...
          if(request.getParameter ("Lista_Ciclos_registrado") !=null )
              {
                ...
                out.println("<thead><td colspan='6' align='center' bgcolor='#D8D8D8' ><b>LISTADOS DE LAPSOS DE TIEMPOS</b></td> ");
                out.println("</thead>");
                out.println("<tbody>");
                out.println("<tr width=\'250\'>");
                out.println("<td align=\'center\' bgcolor='#F2F2F2'><b>Nº</b></td>");
                out.println("<td align=\'center\' bgcolor='#F2F2F2'><b>Modalidad</b></td>");
                out.println("<td align=\'center\' bgcolor='#F2F2F2'><b>Cant. Dias</b></td>");
                out.println("<td align=\'center\' bgcolor='#F2F2F2'><b>Desde</b></td>");  
                out.println("<td align=\'center\' bgcolor='#F2F2F2'><b>Hasta</b></td>");
                out.println("<td align='center' bgcolor='#F2F2F2'><b>Eliminar</b></td> ");                   
                out.println(" </tr> <tr><td> ");                        
...
if(request.getParameter ("Btn_Agregar_Ciclo") !=null )
           ...
           if(request.getParameter ("Listar_Periodo") !=null )
                ...
                while(Res_Per.next())
                      {
                      out.println(Res_Per.getString("Mes_Per")+"-"+Res_Per.getString("Anio_Per"));
                      }   
